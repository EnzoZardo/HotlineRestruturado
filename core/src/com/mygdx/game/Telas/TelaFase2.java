...
public class TelaFase2 extends InputAdapter implements Screen {
    Estados estados;
    ...
    public TelaFase2(Gerenciador gerenciador) {
        this.gerenciador = gerenciador;
        estados = new Estados("core/src/com/mygdx/game/Mapas/fase2.txt");
    ...
    public void passaFase() {
        ...
        if (contMortos == estados.viloes.size) {
            gerenciador.setScreen(new TelaTransicao(gerenciador, new TelaFase3(gerenciador)));
        }
    }
