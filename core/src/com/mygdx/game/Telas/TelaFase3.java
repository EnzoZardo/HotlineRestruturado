...
public class TelaFase3 extends InputAdapter implements Screen {
    Estados estados;
    ...
    public TelaFase3(Gerenciador gerenciador) {
        this.gerenciador = gerenciador;
        estados = new Estados("core/src/com/mygdx/game/Mapas/fase3.txt");
    ...
    public void render(float delta) {
        ScreenUtils.clear(0.5f, 0.4f, 0.4f, 1);
    ...
    public void passaFase() {
        ...
        if (contMortos == estados.viloes.size) {
            gerenciador.setScreen(new TelaTransicao(gerenciador, new TelaVenceu(gerenciador)));
        }
    }
